...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'HamsterHubBundle', ($this->targetDirs[2].'/Resources/HamsterHubBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'HamsterHubBundle', ($this->targetDirs[3].'\\src\\HamsterHubBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'VideoBundle', ($this->targetDirs[2].'/Resources/VideoBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'VideoBundle', ($this->targetDirs[3].'\\src\\VideoBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'EntityBundle', ($this->targetDirs[2].'/Resources/EntityBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'EntityBundle', ($this->targetDirs[3].'\\src\\EntityBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'\\src\\VideoBundle\\Resources\\config\\doctrine') => 'VideoBundle\\Entity'));
        ...
        $b->addDriver($a, 'VideoBundle\\Entity');
        ...
        $c->setEntityNamespaces(array('HamsterHubBundle' => 'HamsterHubBundle\\Entity', 'VideoBundle' => 'VideoBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_8c720fb46331379a461f8a421b30b31c3af3b989e436e4a111949a723a443ac5');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\VideoBundle/Resources/views'), 'Video');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('afec9d2ad3d35503e5392204b30ce50b0150ed36');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'VideoBundle' => 'VideoBundle\\VideoBundle',
            ...
            'secret' => 'afec9d2ad3d35503e5392204b30ce50b0150ed36',
            'locale' => 'fr',
            ...
            'kernel.secret' => 'afec9d2ad3d35503e5392204b30ce50b0150ed36',
